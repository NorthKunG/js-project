<template>
    <div>
        <header>
            <h1 class="mb-3 fw-bold pt-3">Edit Computer</h1>
        </header>
        <div class="container-fluid">
            <div class="d-flex justify-content-center">
                <form v-on:submit.prevent="editComputer" class="row text-start my-3" style="width: 80rem;">
                    <div class="col ms-3">
                        <div class="mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col">
                                ...
                                <input type="number" v-model="computer.price" class="form-control"
                    ...
                    <div class="col me-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col">
                                ...
                                <input type="text" v-model="computer.weight" class="form-control"
                                    placeholder="Enter a Weight" required>
                            </div>
                        </div>
                    </div>
