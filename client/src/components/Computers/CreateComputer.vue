<template>
    <div class="container position-relative position-absolute top-50 start-50 translate-middle">
        <div class="d-flex justify-content-center">
            <form v-on:submit.prevent="createComputer" class="row text-start bg-secondary rounded-2" style="width: 75rem;">
                <h1 class="text-center fw-bold mb-3 mt-3 text-light">Create Computer</h1>
                <hr>
                <div class="col ms-3">
                    <div class="mb-3">
